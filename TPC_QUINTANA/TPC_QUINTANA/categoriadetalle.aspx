<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="categoriadetalle.aspx.cs" Inherits="TPC_QUINTANA.categoriadetalle" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container h-100" style="margin-top: 10%">
        <div class="row h-100 justify-content-center align-items-center">
            <div class="card">
                <asp:Label runat="server" Text="AGREGAR CATEGORIA" ID="title" Style="text-align: center;" CssClass="card-header btn-block"></asp:Label>
                    ...
                    <div role="form">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <asp:TextBox runat="server" type="text" class="form-control" ID="categoriaLabel" required="" />
                            </div>
                            <div>
