...
namespace TPC_QUINTANA
{
    ...
    {
        public List<Articulo> LivingList { get; set; }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                LivingList = negocio.ListarLiving();
                if (!IsPostBack)
                {
                        ...
                        Repeater.DataSource = LivingList;
                        Repeater.DataBind();
                ...
                else
                {
                    if (Session[Session.SessionID + "busqueda"] != null)
                    {
                        ...
                        ListaFiltrada = LivingList.FindAll(A => A.nombre.ToLower().Contains(busqueda.ToLower()));
        ...
        protected void addCarrito_Command(object sender, CommandEventArgs e)
        {
            ...
            try
            {
                ...
                articulo = LivingList.Find(J => J.id == articuloSelec);
