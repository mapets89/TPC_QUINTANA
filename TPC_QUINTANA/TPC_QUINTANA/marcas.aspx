<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="marcas.aspx.cs" Inherits="TPC_QUINTANA.marcas" %>

<asp:Content ID="MarcaContent" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <div>
            <div class="navbar-header" style="margin-left:28%;">
                <h1>
                <asp:Label CssClass="navbar-brand text-title" runat="server" Text="NUESTRAS  MARCAS"></asp:Label>

                </h1>
            </div>
        </div>

        <asp:GridView CssClass="table table-borderless btn-dark text-center datosDgv" ID="dgvMarcas" runat="server" AutoGenerateColumns="false" OnRowCommand="dgvMarcas_RowCommand" Style="width: 700px; margin-left: 15%;">
            <Columns>
                ...
                <asp:BoundField HeaderText="Marcas" HeaderStyle-CssClass="header" DataField="nombre" ItemStyle-CssClass="alert-info datosDgv" />
