<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Cocina.aspx.cs" Inherits="TPC_QUINTANA.Cocina" EnableEventValidation="false" %>

<asp:Content ID="CocinaContent" ContentPlaceHolderID="MainContent" runat="server">
    <style>
        .carousel-custom {
            margin-top: 90px;
            width: 900px;
