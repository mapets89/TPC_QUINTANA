<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Banio.aspx.cs" Inherits="TPC_QUINTANA.Banio" EnableEventValidation="false" %>

<asp:Content ID="BañoContent" ContentPlaceHolderID="MainContent" runat="server">
    <style>
        .carousel-custom {
            margin-top: 90px;
            width: 900px;
