...
{
    public partial class Banio : System.Web.UI.Page
    {
        public List<Articulo> BañoList { get; set; }
            ...
            try
            {
                ...
                else
                {
                    if (Session[Session.SessionID + "busqueda"] != null)
                    {
                        ...
                        ListaFiltrada = BañoList.FindAll(A => A.nombre.ToLower().Contains(busqueda.ToLower()));
        ...
        protected void addCarrito_Command(object sender, CommandEventArgs e)
        {
            ...
            try
            {
                ...
                articulo = BañoList.Find(J => J.id == articuloSelec);
