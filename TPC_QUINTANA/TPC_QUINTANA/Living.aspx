<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Living.aspx.cs" Inherits="TPC_QUINTANA.Living" EnableEventValidation="false" %>

<asp:Content ID="LivingContent" ContentPlaceHolderID="MainContent" runat="server">
    <style>
        .carousel-custom {
            margin-top: 90px;
            width: 900px;
